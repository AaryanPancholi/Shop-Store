...
function Banner() {  return (
    <div className="banner mt-12 w-[80vw] m-auto pt-4 pb-4 mb-20">
    <Slide triggerOnce>
      <div className="bg-red-500 m-6 grid grid-cols-2  px-18">
        {/* 1st column */}
        ...
        <div>
          <div>
            <p className="text-white font-bold text-8xl mt-5">
              Flat <span className="underline">50%</span> off
            </p>
            <p className="text-white mt-3">Available on our all store</p>
          </div>
        </div>
      </div>
    </Slide>
